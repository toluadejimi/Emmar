            ...
            <div class="row">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <input name="zone_name" id="zone_name" class="form-control my-4" value="<?php echo e($zone->zone_name); ?>">
                    ...
                    <script
                        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GOOGLE_MAPS_API_KEY')); ?>&libraries=drawing,places&callback=initMap"
                        async
                        defer>
                    </script>
                    ...
                    <script>
                        ...
                        let latLngs = <?php echo json_encode($coordinates, 15, 512) ?>; // Inject saved coordinates from the server
                        ...
                        function initMap() {
                            ...
                            document.getElementById('update-coordinates').addEventListener('click', function () {
                                ...
                                const zone_id = <?php echo e($zone->id); ?>;
...
<?php echo $__env->make('layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/etop/resources/views/view-zone.blade.php ENDPATH**/ ?>
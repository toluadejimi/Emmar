                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="rounded-circle overflow-hidden me-6">
                                        <img src="<?php echo e(url('')); ?>/public/assets2/images/profile/user-1.jpg" alt="" width="40" height="40">
                                    </div>
                                    <h5 class="fw-semibold mb-0 fs-5">Welcome back <?php echo e(Auth::user()->first_name); ?>!</h5>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="border-end pe-4 border-muted border-opacity-10">
                                        <h3 class="mb-1 fw-semibold fs-8 d-flex align-content-center"><?php echo e(number_format($all_terminals)); ?><i class="ti ti-arrow-up-right fs-5 lh-base text-success"></i></h3>
                                        <p class="mb-0 text-dark">Registered Terminals</p>
                                    </div>

                                    <div class="ps-4">
                                        <h3 class="mb-1 fw-semibold fs-8 d-flex align-content-center"><?php echo e(number_format($customers)); ?><i class="ti ti-arrow-up-right fs-5 lh-base text-success"></i></h3>
                            ...
                            <div class="col-sm-5">
                                <div class="welcome-bg-img text-end">
                                    <img src="<?php echo e(url('')); ?>/public/assets2/images/backgrounds/welcome-bg.svg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-3 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h4 class="fw-semibold text-success">₦<?php echo e(number_format($total_in_transaction ,2)); ?></h4>
                     ...
                     <div class="col-3 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h4 class="fw-semibold text-danger">₦<?php echo e(number_format($total_out_transaction ,2)); ?></h4>
                    ...
                    <div class="col-3 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h4 class="fw-semibold">₦<?php echo e(number_format($total_in_month_transaction ,2)); ?></h4>
                    ...
                    <div class="col-3 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h4 class="fw-semibold">₦<?php echo e(number_format($total_out_month_transaction ,2)); ?></h4>
                        ...
                        <div class="table-responsive mb-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>₦<?php echo e(number_format($data->debit ,2)); ?></td>
                                    <td>₦<?php echo e(number_format($data->credit ,2)); ?></td>
                                    <td>₦<?php echo e(number_format($data->balance ,2)); ?></td>
                                    <td>
                                        <?php if($data->transaction_type == 'PURCHASE'): ?>
                                        <span class="badge bg-primary-subtle rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                         ...
                                         <?php elseif($data->transaction_type == 'Purchase'): ?>
                                        <span class="badge bg-primary-subtle rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                            <iconify-icon icon="mdi:arrow-down-thin"></iconify-icon>
                                            PURCHASE
                                        </span>
                                        <?php elseif($data->transaction_type == 'VirtualFundWallet'): ?>
                                        <span class="badge bg-primary-subtle rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                            <iconify-icon icon="mdi:arrow-down-thin"></iconify-icon>
                                            WALLET FUNDING
                                        </span>
                                        <?php elseif($data->transaction_type == 'BankTransfer'): ?>
                                        <span class="badge bg-primary-subtle rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                            <iconify-icon icon="mdi:arrow-up-thin"></iconify-icon>
                                            BANK TRANSFER
                                        </span>
                                        <?php elseif($data->transaction_type == 'CashOut'): ?>
                                        <span class="badge bg-primary-subtle rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                            <iconify-icon icon="mdi:arrow-down-thin"></iconify-icon>
                                            CASH OUT
                                        </span>

                                        <?php elseif($data->transaction_type == 'EP TRANSFER'): ?>
                                        <span class="badge bg-primary-subtle rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                            <iconify-icon icon="mdi:arrow-down-thin"></iconify-icon>
                                            EP TRANSFER
                                        </span>
                                    ...
                                    <td>₦<?php echo e(number_format($data->e_charges ,2)); ?></td>
...
<div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
        <ul class="mb-0">
            <li class="pb-7">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(url('')); ?>/public/assets2/images/products/product-1.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                    <div>
            ...
            <li class="pb-7">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(url('')); ?>/public/assets2/images/products/product-2.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                    <div>
                        <h6 class="mb-1">Supreme toys cooker</h6>
                        <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                        <div class="d-flex align-items-center justify-content-between mt-2">
            ...
            <li class="pb-7">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(url('')); ?>/public/assets2/images/products/product-3.jpg" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                    <div>
                        <h6 class="mb-1">Supreme toys cooker</h6>
                        <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                        <div class="d-flex align-items-center justify-content-between mt-2">
...
<?php echo $__env->make('layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/etop/resources/views/home.blade.php ENDPATH**/ ?>
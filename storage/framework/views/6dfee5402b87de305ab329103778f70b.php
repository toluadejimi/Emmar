...
<!-- Favicon icon-->
    ...
    <link rel="stylesheet" href="<?php echo e(url('')); ?>/public/assets2/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css" />
...
<body>
            ...
            <div>
                ...
                <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
                    <div class="hstack gap-3">
                        <div class="john-img">
                            <img src="<?php echo e(url('')); ?>/public/assets2/images/profile/user-1.jpg" class="rounded-circle" width="40" height="40" alt="" />
                        </div>
                        <div class="john-title">
                            <h6 class="mb-0 fs-4 fw-semibold"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></h6>
                                        ...
                                        <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
                                            <div class="d-flex align-items-center">
                                                <div class="user-profile-img">
                                                    <img src="<?php echo e(url('')); ?>/public/assets2/images/profile/user-1.jpg" class="rounded-circle" width="35" height="35" alt="" />
                                                </div>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                                            <div class="profile-dropdown position-relative" data-simplebar>
                                                ...
                                                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                                    <img src="<?php echo e(url('')); ?>/public/assets2/images/profile/user-1.jpg" class="rounded-circle" width="80" height="80" alt="" />
                                                    <div class="ms-3">
                                                        <h5 class="mb-1 fs-3"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></h5>
                                                ...
                                                <div class="message-body">
                                                    <a href="#" class="py-8 px-7 mt-8 d-flex align-items-center">
                                                        <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                            <img src="<?php echo e(url('')); ?>/public/assets2/images/svgs/icon-account.svg" alt="" width="24" height="24" />
                                                        </span>
    ...
    <script src="<?php echo e(url('')); ?>/public/assets2/libs/apexcharts/dist/apexcharts.min.js"></script>
    <script src="<?php echo e(url('')); ?>/public/assets2/js/dashboards/dashboard2.js"></script>

    <script src="<?php echo e(url('')); ?>/public/assets2/libs/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo e(url('')); ?>/public/assets2/js/datatable/datatable-basic.init.js"></script>
    ...
    <script src="<?php echo e(url('')); ?>/public/assets2/js/datatable/datatable-advanced.init.js"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/etop/resources/views/layout/home.blade.php ENDPATH**/ ?>